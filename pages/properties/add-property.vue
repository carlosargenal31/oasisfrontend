<template>
  <div class="bg-white">
    ...
    <div class="container pt-4 px-6">
      <div class="flex items-center text-sm">
        ...
        <span class="text-orange-800">Añadsr Comercio</span>
      </div>
    </div>

    <div class="container px-6 pt-6 pb-10">
      <h1 class="text-3xl font-bold mb-8">Añadsir Comercio</h1>
        ...
        <div class="col-span-12 lg:col-span-8">
          ...
          <div class="lg:hidden mb-6">
            <div class="flex justify-between items-center mb-2">
              <span class="text-sm font-medium text-gray-700">{{ progress }}% contenido completado</span>
            </div>
          ...
          <form @submit.prevent="handleSubmit">
            ...
            <section class="mb-8" id="photos">
              ...
              <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <!-- Preview images -->
                <div v-if="selectedFiles.length > 0" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4gap-4 mt-4">
            ...
            <!-- Contacts -->
            <section class="mb-8" id="contacts">
              <div class="flex items-center mb-4">
                <div class="w-10 h-10 rounded-full bg-orange-100 flex items-center justify-center mr-3">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-orange-800" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <aside class="hidden lg:block lg:col-span-4">
          <div class="sticky top-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <ul class="space-y-3">
              ...
              <li class="flex items-center">
                <div :class="[isContactsComplete ? 'bg-orange-800 text-white' : 'bg-gray-200 text-gray-400', 'w-6 h-6 rounded-full flex items-center justify-center mr-3']">
                  <svg v-if="isContactsComplete" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <a href="#contacts" class="text-gray-800 hover:text-orange-800">Contactos</a>
              </li>
            </ul>
          </div>
        </aside>
            ...
            <div class="max-h-[70vh] overflow-y-auto p-4">
              ...
              <div class="grid grid-cols-12 gap-4 mb-8">
                <div class="col-span-12 sm:col-span-8 h-64">
                  <div class="bg-gray-200 rounded-lg h-full flex items-center justify-center" v-if="!previewUrls[0]">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <img v-else :src="previewUrls[0]" class="w-full h-full object-cover rounded-lg" alt="Imagen principal" />
                </div>
                <div class="col-span-12 sm:col-span-4 grid grid-rows-2 gap-4">
                  <div class="bg-gray-200 rounded-lg h-full flex items-center justify-center" v-if="!previewUrls[1]">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <img v-else :src="previewUrls[1]" class="w-full h-full object-cover rounded-lg" alt="Imagen adicional" />
                  
                  <div class="bg-gray-200 rounded-lg h-full flex items-center justify-center" v-if="!previewUrls[2]">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <img v-else :src="previewUrls[2]" class="w-full h-full object-cover rounded-lg" alt="Imagen adicional" />
                </div>
              </div>
  ...
  <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" />
                      ...
                      <li class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400 mr-3" viewBox="0 0 20 20" fill="currentColor">
                          <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.9971.884z" />
                      ...
                      <li v-if="contactInfo.company" class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400 mr-3" viewBox="0 0 20 20" fill="currentColor">
...
const formData = ref({
  ...
  district: '',
  lat: 15.505, // Posición por defecto (ajusta a una ubicación por defecto para Honduras)
...
onMounted(() => {
  // Asegúrate de que Leaflet está disponible y el contenedor del mapa existe
...
// Submit form
// Submit form
// Modifica la función handleSubmit en add-property.vue para convertir los booleanos en números
const handleSubmit = async () => {
  try {
    ...
    // Añadir info de contacto
    propertyFormData.append('contact', JSON.stringify(contactInfo.value));
    
    // Añadir imagen principal si está disponible
    ...
    // Llamar a la API en el puerto correcto con el token de autenticación
    ...
    if (response.data.success) {
      ...
      // Mostrar notificación en la parte superior (asumiendo que tienes este método disponible)
      // Si no tienes un sistema de notificaciones, puedes usar el siguiente código para crear uno temporal
      showTopNotification('Propiedad creada con éxito', 'success');
      
      // Redirigir a la página de inicio después del éxito
      setTimeout(() => {
        router.push('/'); // Redirige al inicio en lugar de /properties
      }, 2000);
    } else {
      errorMessage.value = response.data.message || 'Error al crear la propiedad';
      showTopNotification('Error al crear la propiedad', 'error');
    }
  } catch (error) {
...
// Observar cambios en el status para cambiar texto entre "por mes" y "precio total"
watch(
  () => formData.value.status,
  () => {
    // El cambio ahora se maneja directamente en el template con v-if/v-else
  }
);
