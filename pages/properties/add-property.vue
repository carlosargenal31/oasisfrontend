  ...
  <div class="bg-white">
    ...
    <div class="container pt-4 px-6">
      <div class="flex items-center text-sm">
        ...
        <span class="text-blue-800">Añadir Propiedad</span>
      </div>
    </div>
        ...
        <aside class="hidden lg:block lg:col-span-4">
          <div class="sticky top-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <ul class="space-y-3">
              ...
              <li class="flex items-center">
                <div :class="[isContactsComplete ? 'bg-blue-800 text-white' : 'bg-gray-200 text-gray-400', 'w-6 h-6 rounded-full flex items-center justify-center mr-3']">
                  <svg v-if="isContactsComplete" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <a href="#contacts" class="text-gray-800 hover:text-blue-800">Contactos</a>
              </li>
            </ul>
          </div>
        </aside>
