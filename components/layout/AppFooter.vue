          ...
          <div class="flex flex-col md:flex-row justify-between">
            <div class="mb-8 md:mb-0 md:mr-12">
              <router-link class="inline-block mb-6" to="/">
                <h1 class="text-xl font-bold text-orange-600 ">En La Ceiba</h1>
              </router-link>
              
              <ul class="space-y-3">
                <li>
                  <a href="mailto:info@oasis-realestate.com" class="text-gray-600  hover:text-orange-600  flex items-center">
                ...
                <li>
                  <a href="tel:5551234567" class="text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div class="flex mt-6">
                <a href="#" class="w-10 h-10 rounded-full bg-white  flex items-center justify-center mr-2 shadow-sm text-orange-600 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-gray-600 transition duration-200">
                ...
                <a href="#" class="w-10 h-10 rounded-full bg-white  flex items-center justify-center shadow-sm text-orange-600 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-gray-600 transition duration-200">
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
